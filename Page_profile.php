...
$co = connexionBdd();
?>
<div class="row py-5 px-4" style="margin-top: 4%;">
    <div class="col-md-5 mx-auto">
        <div class="bg-white shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    <div class="profile mr-3"><img src="photo.png" alt="..." width="130"
                                                   class="rounded mb-2 img-thumbnail"><a data-toggle="modal"
                                                                                         data-target="#exampleModal"
                                                                                         class="btn btn-outline-dark btn-sm btn-block">Editer
                            le profile</a></div>
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form name="insertion" action="Page_Profile.php" method="POST">
                                        <table width="500" border="0" align="center" cellpadding="6" cellspacing="0"
                                               bgcolor="">
                                            <tr>
                                                <td><FONT COLOR="">Nouveau mot de passe :<b
                                                                style="color: #990000;">*</b></color></td>
                                                <td><input type="password" name="pass"
                                                           placeholder="Ancien mot de passe"></td>
                                            </tr>
                                            <tr>
                                                <td><FONT COLOR="">Nouveau pseudo :<b
                                                                style="color: #990000;">*</b></color></td>
                                                <td><input type="text" name="pseudo"
                                                           placeholder=<?php echo($_SESSION["pseudoUtilisateur"]) ?>>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><FONT COLOR="">Nouveau mail:</color></td>
                                                <td><input type="email" name="email" placeholder="Ancien mail"></td>
                                            </tr>
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-primary" name="confirm" value="1">Save
                                        changes
                                    </button>
                                </div>
                                </form>
                ...
                <div class="media-body mb-5 text-white">
                    <h4 class="text-dark"><?php echo $_SESSION["pseudoUtilisateur"] ?></h4><i
